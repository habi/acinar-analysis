...
\begin{figure}
	\subfloat[Light microscopy image, \SI{10}{x} magnification.]{
		\includegraphics[width=\imsize]{../JPGs/R108C21E_I_8_1_my}
		}
	\subfloat[Full reconstructed slice from the tomographic dataset.]{
		...
		\begin{tikzpicture}[x=\imagescale,y=-\imagescale, spy using outlines={rectangle, magnification=\mag, size=\size, connect spies}]
			\begin{scope}
				...
				\node[anchor=north west, inner sep=0pt, outer sep=0pt] at (0,0) {\includegraphics[width=\imagewidth]{../Originals_TOMCAT/{{R108C21E_B1_mrg1024.rec.8bit}}}};
			\end{scope}
	...
	\subfloat[Detail (middle slice) from acinus 38.
		   ...
		   Scale bar is \SI{100}{\micro\meter}]{
			   \includegraphics[width=\imsize]{../Originals_TOMCAT/R108C21E_B1_mrg-acinus38_28_a}
		}
%-------------
\end{figure}
\end{document}