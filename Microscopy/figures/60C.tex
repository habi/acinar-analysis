...
\begin{document}
\begin{figure}
	\subfloat[Light microscopy image, \SI{10}{x} magnification.]{\includegraphics[width=\imsize]{../JPGs/R108C60C_I_8_0_my}}\\%
	\subfloat[Full reconstructed slice from the tomographic dataset.]{%
		...
		\def\y{1160}% scalebar-y at 90% of image height of 2936px = 2642
		\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
			\node[anchor=north west, inner sep=0pt, outer sep=0pt] at (0,0) {\includegraphics[width=\imagewidth]{../Originals_TOMCAT/{{R108C60C_B1-mrg1024.rec.8bit.edit}}}};
	...
	\subfloat[Detail image (middle slice) from acinus 4.
			The segmented acinus is shown in light grey inset into the original data.
			Scale bar is \SI{100}{\micro\meter}]{%
		\includegraphics[width=\imsize]{../Originals_TOMCAT/{{R108C60C_B1-mrg-acinus04_21_a.edit}}}%
		}%
\end{figure}
\end{document}
